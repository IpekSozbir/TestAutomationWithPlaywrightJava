...
public class C16_LocatorAssertions {
    ...
    public static void main(String[] args) {
        ...
        // 1. ADIM: Pop-up butonunu tanimliyoruz (Loglardaki aria-label'i kullanmak,cok daha saglamdir)
        Locator closeButton = page.getByLabel("Close dialogue");

        // 2. ADIM: Eger buton varsa ve gorunurse tikla (Zorlamadan!)
        if (closeButton.isVisible()) {
            closeButton.click();
            System.out.println("Pop-up yakalandı ve kapatıldı.");
        } else {
            // Eger buton o an gorunmuyorsa ama aslinda oradaysa, biraz beklemesini soyleyebiliriz
            try {
