...
public class C12_Screenshot_Pdf {
    ...
    public static void main(String[] args) {
       ...
       page.screenshot(new Page.ScreenshotOptions().setPath(Paths.get("src/test/java/testInputAndOutput//P12.png")));
        ...
        page.screenshot(new Page.ScreenshotOptions().setPath(Paths.get("src/test/java/testInputAndOutput//P12_1.png")).setFullPage(true));
        ...
        String dosyaYolu = "src/test/java/testInputAndOutput/logo.png";
