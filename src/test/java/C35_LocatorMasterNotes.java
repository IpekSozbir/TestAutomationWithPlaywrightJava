 ...
 * ---------------------------------------------------
 * Bu class, Playwright'ta element bulma işleminin (Locating)
...
public class C35_LocatorMasterNotes {
    ...
    public void builtInLocators(Page page) {
        ...
        // 4. getByText(): Ekranda net olarak görünen herhangi bir metne bakar.
    ...
    public void criticalDifferences(Page page) {
        ...
        // innerText   -> Kullanıcının gözüyle gördüğü metin.
